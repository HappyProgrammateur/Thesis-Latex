...
\newcommand{\docStudiengang}{M.Sc. Applied Computer Science}
...
%   \renewcommand{\runningauthor}{ - #3}%
%   \IfNoValueTF{#1}
%     {\chapter[#2]{#2\origtitle{#3}}}
%     {\chapter[#1]{#2\origtitle{#3}}}%
%}
%\newcommand\origtitle[1]{\\
%  \parbox{\textwidth}{\normalsize\vspace*{\baselineskip}Autor: #1}}
%\newcommand\origsection[1]{\\
%    \parbox{\textwidth}{\normalsize\vspace*{0.5\baselineskip}Autor: #1}}
%\NewDocumentCommand{\thesissection}{o m m}{%
%   \renewcommand{\runningauthor}{ - #3}%
%   \IfNoValueTF{#1}
%     {\section[#2]{#2\origsection{#3}}}
%     {\section[#1]{#2\origsection{#3}}}%
%}
%\NewDocumentCommand{\thesissubsection}{o m m}{%
%   \renewcommand{\runningauthor}{ - #3}%
%   \IfNoValueTF{#1}
%     {\subsection[#2]{#2\origsection{#3}}}
%     {\subsection[#1]{#2\origsection{#3}}}%
%}
%    
