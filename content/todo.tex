...
% HOG werden durch exemplar svm geniert
% maske M_p wird von pixel auf zelle M_c umgerechnet
\[
M_c = M_p
\]
% mit bicubic kernel convolved
\[
k_x = \begin{cases}
...
\]
% alle 5x5 bloecke die nicht komplett innerhalb der bbox liegen werden discarded
